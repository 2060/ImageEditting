...
$(window).resize(function () {
	...
	$('canvas').attr('height', $(window).height() - 43).attr('width', $(window).width() - 232);
	$('ul#mainmenu').width($(window).width() - 4);
	$('ul#layers').css({ height: $(window).height() - 50 });
...
$(document).ready(function () {
	...
	$('#button-filterbrightness-incr').click(app.callbacks.filterBrightnessIncrease);
	$('#button-filterbrightness-decr').click(app.callbacks.filterBrightnessDecrease);
